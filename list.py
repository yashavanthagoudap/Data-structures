...
##POP method:delete the element through the index or if you are not providede the index it will delete the last element
print(myList.pop())  
print(myList)
...
lan='python'
new_list=[letter for letter in lan]
print(lan)
print(new_list)

# CONDITIONAL LIST COMPREHENSION
prev_list=[-1,10,-20,-3,30,40]
new_list=[number*number for number in prev_list if number<0]
print(new_list)

sentence='my name is yashu patil'
...
prev_list=[-1,10,-3,40,50,-2,38,-78,-28]
